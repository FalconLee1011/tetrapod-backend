...
def _createRoom():
    ...
    if(receiver == None): return make_response({"error": "cannot chat with someone called 'NULL'"}, 400)
    elif(receiver == account): return make_response({"error": "are you this lone?"}, 400)
    res = MODEL.new(
        {
